    ...
    <div>
      ...
      <div className="page-container">
        ...
        {reversedHistory.length === 0 ? (
          <p>No history found. Go to Check Score to get your score.</p>
        ) : (
            ...
            {reversedHistory.map((item, index) => (
              <div key={index} className="history-item">
                ...
                <div className="history-right">
                  <span className="history-score" style={{ color: getColor(item.score) }}>
                    {item.score}
                  </span>
                  <span className="history-label" style={{ color: getColor(item.score) }}>
                    {getLabel(item.score)}
                  </span>
                </div>
              </div>
