...
// Helper function to get score label and color
...
function Dashboard() {
  ...
  // Score factors data (hardcoded for demo)
  const factors = [
    ...
    <div>
      ...
      <div className="page-container">
        ...
        <div className="score-card">
          ...
          <span className="score-badge" style={{ color: scoreInfo.color }}>
            {scoreInfo.label}
          </span>
        ...
        <div className="stats-row">
          <div className="stat-box">
            ...
            <p className="stat-label">Payment History</p>
          </div>
          <div className="stat-box">
          ...
          <div className="stat-box">
            <p className="stat-value">₹2.1L</p>
            <p className="stat-label">Credit Limit</p>
          </div>
          <div className="stat-box">
            <p className="stat-value">5 yrs</p>
            <p className="stat-label">Credit Age</p>
          </div>
        </div>
              ...
              {scoreHistory.map((item, index) => {
                ...
                return (
                  <div key={index} className="trend-col">
                    ...
                    <div
                      className="trend-bar"
                      style={{ height: height + "px", backgroundColor: getScoreInfo(item.score).color }}
                    ></div>
